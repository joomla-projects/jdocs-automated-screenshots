...
class generatorCest
{
	...
	{
		$this->baseDir = dirname(dirname(__DIR__)) . '/screenshots/';

		$this->urlConfig = Symfony\Component\Yaml\Yaml::parse(file_get_contents('tests/screenshots/screenshot.urls.yml'));
